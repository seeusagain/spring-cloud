...
public class ShardingTestController {
  ...
  public List<GoodsInfoQuery> queryGoodsById(
  ...
  @ApiImplicitParams({
      @ApiImplicitParam(name = "goodsName", value = "名称", required = true, paramType = "query")})
  @GetMapping(value = "/queryGoodsByName")
  public List<GoodsInfoQuery> queryGoodsByName(
